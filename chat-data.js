...
window.ChatData = (() => {
  ...
  const POOLS = {
    vendors: {
      ...
      household: ["PROCTER & GAMBLE", "CHURCH & DWIGHT CO", "HENKEL CORP", "UNILEVER", "THE CLOROX CO", "RECKITT BENCKISER", "KIMBERLY CLARK CORP", "GEORGIA PACIFIC", "COLGATE PALMOLIVE", "OWN BRANDS"],
    ...
    smics: {
      ...
      household: ["LAUNDRY DETERGENT", "BATH TISSUE", "PAPER TOWELS", "DISH DETERGENT", "FABRIC SOFTENER", "HOUSEHOLD CLEANERS"],
